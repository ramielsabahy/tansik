      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active treeview">
            <a href="#">
              <i class="fa fa-dashboard"></i> <span>ادارة الخدمات</span><i class="fa fa-angle-left pull-left"></i>
              <ul class="treeview-menu">
                <li><a href="{{ route('service') }}"><i class="fa fa-circle-o"></i>انشاء خدمه جديده</a></li>
                <li><a href="{{ route('showService') }}"><i class="fa fa-circle-o"></i>عرض الخدمات</a></li>
              </ul>
            </a>
          </li>
          <li class="treeview active">
            <a href="{{ route('products') }}">
              ...
              <span>ادارة المنتجات</span><i class="fa fa-angle-left pull-left"></i>
              <ul class="treeview-menu">
                <li><a href="{{ route('products') }}"><i class="fa fa-circle-o"></i>انشاء منتج جديده</a></li>
                <li><a href="{{ route('showProduct') }}"><i class="fa fa-circle-o"></i>عرض المنتجات</a></li>
              </ul>
            </a>
          </li>
          <li class="treeview">
          ...
          <li class="treeview">
            <a href="{{ route('serviceOrders') }}">
              ...
              <span>ادارة الخدمات المطلوبه</span>
            </a>
          </li>
          <li>
