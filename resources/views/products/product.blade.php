...
<section class="content" style="height: 586px">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">انشاء منتج جديد</div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default">
				        ...
				        <div class="panel-body">
				            <form id="myForm" method="POST" action="{{ route('createProduct') }}" enctype="multipart/form-data" data-validate="parsley">
				                {{ csrf_field() }}
				                ...
				                <div class="form-group">
				                    ...
				                    <textarea class="form-control" data-parsley-trigger="change focusout" data-parsley-required='' name="desc" id="desc" style="width: 100%"></textarea>
				                </div>
